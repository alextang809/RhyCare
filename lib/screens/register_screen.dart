    ...
    if (form!.validate()) {
      ...
      try {
        ...
        if (errorCode == 'email-already-in-use') {
          Fluttertoast.showToast(
            msg: 'The email address already exists. You might be using "Sign in with Google" before. Otherwise, please login using your password or use the "Forgot your password?" function on the Login page to reset a password!',
